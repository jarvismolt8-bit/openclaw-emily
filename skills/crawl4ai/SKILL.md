...
# Structured data extraction (articles, news, etc.)
python scripts/extract_structured.py https://www.nbcnews.com/business --pattern nbc_news

# Auto-discover pattern and extract
python scripts/extract_structured.py https://example.com/news --discover --output json

# Data extraction with schema generation
