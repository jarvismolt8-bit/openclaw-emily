# Browser Skill - Emily's Web Browser

This skill configures Emily to use **Google Chrome** as the primary browser for web browsing, with **Browserless** as the alternative fallback.
...
## Emily's Default Browser Protocol
